...
const LocationModal: React.FC<Props> = ({
  ...
  // Agar location yoki bridge mavjud bo'lmasa, hech narsa ko'rsatilmasin

  // useMemo har doim chaqiriladi, lekin ichida shart bor
  const images = bridge?.images ?? []; // agar undefined bo‘lsa, bo‘sh array
      ...
      <div className="mb-9 h-auto gap-2 space-y-2 overflow-hidden p-4 pl-8 text-lg text-[#f35a02]">
        ...
        <p>
          ...
          <a
            ...
            target={"_blank"}
            href={bridge.asos_hujjat || undefined}
        ...
        <p>
          ...
          <a
            className={"text-[#744817] underline dark:text-amber-200"}
            target={"_blank"}
            href={bridge.vaqtinchalik_yol_sxemasi || undefined}
            rel="noopener noreferrer"
          >
            {t("Hujjatga Havola")}
          </a>
